...
public class LoansServiceImpl implements ILoansService {
    ...
    public void createLoan(String mobileNumber) {
        Optional<Loans> optionalCustomer = loansRepository.findByMobileNumber(mobileNumber);
        if (optionalCustomer.isPresent()) {
            throw new LoanAlreadyExistsException("Loans already registered with given mobileNumber " + mobileNumber);
        }
